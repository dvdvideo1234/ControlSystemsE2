...
FSD["setFSensor(e:vv)"] = "Returns "..xfs.." local to the entity by "..par[2]..", "..par[3]..", zero "..par[4]
FSD["newFSensor(vv)"] = "Returns "..xfs.." relative to the world by "..par[2]..", "..par[3]..", zero "..par[4]
FSD["setFSensor(e:v)"] = "Returns "..xfs.." local to the entity by "..par[2]..", zero "..par[3]..", zero "..par[4]
FSD["newFSensor(v)"] = "Returns "..xfs.." relative to the world by "..par[2]..", zero "..par[3]..", zero "..par[4]
FSD["setFSensor(e:)"] = "Returns "..xfs.." local to the entity by zero "..par[2]..", zero "..par[3]..", zero "..par[4]
FSD["newFSensor()"] = "Returns "..xfs.." relative to the world by zero "..par[2]..", zero "..par[3]..", zero "..par[4]
...
FSD["getMask(xfs:)"] = "Returns "..xfs.." trace hit mask enums MASK"
FSD["setMask(xfs:n)"] = "Updates "..xfs.." trace hit mask enums MASK"
FSD["getCollisionGroup(xfs:)"] = "Returns "..xfs.." trace collision group enums COLLISION_GROUP"
FSD["setCollisionGroup(xfs:n)"] = "Updates "..xfs.." trace collision group enums COLLISION_GROUP"
