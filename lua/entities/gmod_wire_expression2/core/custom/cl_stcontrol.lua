...
E2Helper.Descriptions["tuneAH(xsc:nnn)"] = "Tunes state controller using the method (AH) Astrom-Hagglund"
...
E2Helper.Descriptions["tuneIAE(xsc:nnn)"] = "Tunes state controller using the method (IAE) Integral absolute error"
E2Helper.Descriptions["tuneISE(xsc:nnn)"] = "Tunes state controller using the method (ISE) Integral square error"
E2Helper.Descriptions["tuneITAE(xsc:nnn)"] = "Tunes state controller using the method (ITAE) Integral of time-weighted absolute error"
