...
E2Helper.Descriptions["remGainID(xsc:)"] = "Removes state controller integral and derivative term gain"
E2Helper.Descriptions["remGainP(xsc:)"] = "Removes state controller proportional term gain"
E2Helper.Descriptions["remGainPD(xsc:)"] = "Removes state controller proportional and derivative term gain"
E2Helper.Descriptions["remGainPI(xsc:)"] = "Removes state controller proportional and integral term gain"
...
E2Helper.Descriptions["setGainID(xsc:nn)"] = "Updates state controller integral and derivative term gain"
E2Helper.Descriptions["setGainID(xsc:r)"] = "Updates state controller integral and derivative term gain"
E2Helper.Descriptions["setGainID(xsc:xv2)"] = "Updates state controller integral and derivative term gain"
E2Helper.Descriptions["setGainP(xsc:n)"] = "Updates state controller proportional term gain"
E2Helper.Descriptions["setGainPD(xsc:nn)"] = "Updates state controller proportional and derivative term gain"
E2Helper.Descriptions["setGainPD(xsc:r)"] = "Updates state controller proportional and derivative term gain"
E2Helper.Descriptions["setGainPD(xsc:xv2)"] = "Updates state controller proportional and derivative term gain"
E2Helper.Descriptions["setGainPI(xsc:nn)"] = "Updates state controller proportional and integral term gain"
E2Helper.Descriptions["setGainPI(xsc:r)"] = "Updates state controller proportional and integral term gain"
E2Helper.Descriptions["setGainPI(xsc:xv2)"] = "Updates state controller proportional and integral term gain"
...
E2Helper.Descriptions["setPower(xsc:nnn)"] = "Updates state controller proportional, integral and derivative term power"
E2Helper.Descriptions["setPower(xsc:r)"] = "Updates state controller proportional, integral and derivative term power"
E2Helper.Descriptions["setPower(xsc:v)"] = "Updates state controller proportional, integral and derivative term power"
...
E2Helper.Descriptions["setPowerID(xsc:nn)"] = "Updates state controller integral and derivative term power"
E2Helper.Descriptions["setPowerID(xsc:r)"] = "Updates state controller integral and derivative term power"
E2Helper.Descriptions["setPowerID(xsc:xv2)"] = "Updates state controller integral and derivative term power"
E2Helper.Descriptions["setPowerP(xsc:n)"] = "Updates state controller proportional term power"
E2Helper.Descriptions["setPowerPD(xsc:nn)"] = "Updates state controller proportional and derivative term power"
E2Helper.Descriptions["setPowerPD(xsc:r)"] = "Updates state controller proportional and derivative term power"
E2Helper.Descriptions["setPowerPD(xsc:xv2)"] = "Updates state controller proportional and derivative term power"
E2Helper.Descriptions["setPowerPI(xsc:nn)"] = "Updates state controller proportional and integral term power"
E2Helper.Descriptions["setPowerPI(xsc:r)"] = "Updates state controller proportional and integral term power"
E2Helper.Descriptions["setPowerPI(xsc:xv2)"] = "Updates state controller proportional and integral term power"
...
E2Helper.Descriptions["tuneAH(xsc:nnn)"] = "Tunes the state controller using the method (AH) Astrom-Hagglund"
E2Helper.Descriptions["tuneAutoZN(xsc:nn)"] = "Tunes the state controller using the method (ZN) Ziegler-Nichols auto-oscillation"
E2Helper.Descriptions["tuneAutoZN(xsc:nns)"] = "Tunes the state controller using the method (ZN) Ziegler-Nichols auto-oscillation extended by type: `classic`, `pessen`, `sovers`, `novers`"
E2Helper.Descriptions["tuneIAE(xsc:nnn)"] = "Tunes the state controller using the method (IAE) Integral absolute error"
E2Helper.Descriptions["tuneISE(xsc:nnn)"] = "Tunes the state controller using the method (ISE) Integral square error"
E2Helper.Descriptions["tuneITAE(xsc:nnn)"] = "Tunes the state controller using the method (ITAE) Integral of time-weighted absolute error"
E2Helper.Descriptions["tuneOverCHRLR(xsc:nnn)"] = "Tunes the state controller using the method (CHR) Chien-Hrones-Reswick load rejection 20% overshot"
E2Helper.Descriptions["tuneOverCHRSP(xsc:nnn)"] = "Tunes the state controller using the method (CHR) Chien-Hrones-Reswick set point track 20% overshot"
E2Helper.Descriptions["tuneProcCC(xsc:nnn)"] = "Tunes the state controller using the method (CC) Choen-Coon"
E2Helper.Descriptions["tuneProcCHRLR(xsc:nnn)"] = "Tunes the state controller using the method (CHR) Chien-Hrones-Reswick load rejection"
E2Helper.Descriptions["tuneProcCHRSP(xsc:nnn)"] = "Tunes the state controller using the method (CHR) Chien-Hrones-Reswick set point track"
E2Helper.Descriptions["tuneProcZN(xsc:nnn)"] = "Tunes the state controller using the method (ZNM) Ziegler-Nichols plant process"