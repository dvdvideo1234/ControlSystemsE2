...
E2Helper.Descriptions["isIntegral(xsc:)"] = "Checks integral enabled flag"
E2Helper.Descriptions["isDerivative(xsc:)"] = "Checks derivative enabled flag"
...
E2Helper.Descriptions["tuneAutoZN(xsc:nns)"] = "Tunes the state control using the Ziegler-Nichols auto-oscillation method with overshot option (ZN)"
