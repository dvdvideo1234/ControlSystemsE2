...
DSC["allStControl()"] = act[1].." the used "..xsc.." count"
DSC["maxStControl()"] = act[1].." the upper "..xsc.." count"
DSC["remove(xsc:)"] = act[3].." the "..xsc.." from the list"
DSC["copy(xsc:)"] = act[1].." "..xsc.." object copy instance"
